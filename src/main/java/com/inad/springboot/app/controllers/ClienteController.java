package com.inad.springboot.app.controllers;
...
import com.inad.springboot.app.models.entity.Cliente;
import com.inad.springboot.app.models.service.IClienteService;
import com.inad.springboot.app.models.service.IUploadService;
import com.inad.springboot.app.util.paginator.PageRender;
...
public class ClienteController {
	...
	// Implementa el patrón de diseño Facade
	@Autowired
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		if (auth != null) {
			//logger.info("Utilizando forma estatica SecurityContextHolder.getContext().getAuthentication(): Usuario autenticado, tu username es; ".concat(authentication.getName()));
		}
	...
	public String guardar(@Valid Cliente cliente, BindingResult result, Model model,
		...
		// Validamos con result (@Valid habilita la validación en el objeto mapeado al
		// Form
		if (result.hasErrors()) {
